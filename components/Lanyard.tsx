...
import styles from '../styles/Lanyard.module.css';
...
const [isMobile, setIsMobile] = useState(false);
  ...
  <div className={styles.lanyardCanvasContainer}>
      <Canvas
        style={{ width: '100vw', height: '100vh' }}
        camera={{
            position: isMobile ? [0, 0, 28] : [0, 0, 20],
            fov: isMobile ? 22 : 20,
          }}
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  const [dragged, setDragged] = useState<false | { x: number, y: number, z: number }>(false);
  ...
  return (
    <>
      <group position={isMobile ? [0.8, 6, 0] : [4, 4, 0]}>
